...
extension UIAlertController {
    ...
    func addOneTextField(configuration: TextField.Config?) {
        let textField = OneTextFieldViewController(vInset: preferredStyle == .alert ? 12 : 10, configuration: configuration)
        textField.textField.layer.cornerRadius = 9
        textField.textField.clipsToBounds = true
