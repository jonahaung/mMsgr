...
extension UIAlertController {
    ...
    func addPhotoLibraryPicker(flow: UICollectionView.ScrollDirection, paging: Bool, selection: PhotoLibraryPickerViewController.Selection) {
        ...
        let buttonAdd = UIAlertAction(title: "Select", style: .default) { action in
            switch selection {
...
final class PhotoLibraryPickerViewController: UIViewController {
    ...
    var columns: CGFloat {
        ...
        case .vertical: return UIDevice.current.userInterfaceIdiom == .pad ? 4 : 3
    ...
    var itemSize: CGSize {
        switch layout.scrollDirection {
        case .vertical:
            return CGSize(view.bounds.width / columns)
        case .horizontal:
