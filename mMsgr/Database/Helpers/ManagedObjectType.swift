...
extension Room: ManagedObjectType {
    
}
extension Friend: ManagedObjectType {
    
}
extension Dic: ManagedObjectType {
    
}
extension Translate: ManagedObjectType {
    
}
extension Pronounce: ManagedObjectType {}
...
public extension ManagedObjectType where Self: NSManagedObject {
    ...
    static func deleteAllData(predicate: NSPredicate? = nil, _ completion: ((_ finished: Bool) -> Void)? = nil){
        ...
        context.performAndWait {
            do {
                ...
                print("The batch delete request has deleted \(entityName): \(batchDeleteResult.result!) records.")
